...
public class UIBatchRenderer {
    ...
    public void queue(UI ui) {
        ...
        // Determine texture coordinates. For untextured UI, use (0,0) to (1,1)
        // or any default that doesn't cause issues.
        // If ui.getTexture() is null, we assume no texture is used.
        boolean useTexture = ui.getTexture() != null;
